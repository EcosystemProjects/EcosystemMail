...
return!0;if(typeof value==='string'){return this.whitelist.indexOf(value.replace(/["']/g,''))>-1}
...
else{this.remove()}}};ContainerBlot.prototype.path=function(index,inclusive){if(inclusive===void 0){inclusive=!1}
...
FormatBlot.formats=function(domNode){if(typeof this.tagName==='string'){return!0}
...
else if(this.next instanceof TextBlot&&this.next.prev===this){this.insertAt(this.length(),this.next.value());this.next.remove()}};TextBlot.prototype.position=function(index,inclusive){if(inclusive===void 0){inclusive=!1}
